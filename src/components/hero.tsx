  ...
  return (
    <div className="flex max-w-7xl flex-col items-center justify-center ">
      ...
      <div className="flex flex-col items-center justify-center gap-6 md:flex-row md:items-start">
        ...
        <svg
          className="w-16 shrink-0 fill-github-white opacity-70 max-md:-scale-x-100 md:-rotate-90"
          viewBox="0 0 138 138"
          fill="none"
        ...
        <svg
          className="w-16 shrink-0 fill-github-white opacity-70 md:-rotate-90 md:-scale-x-100"
          viewBox="0 0 138 138"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
