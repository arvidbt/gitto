    ...
    <div className="flex max-w-7xl flex-col items-center justify-center ">
      <div className=" flex flex-col items-center justify-center gap-12 px-4 py-16 ">
        <div>
          ...
          <h2 className="text-github-muted text-xl font-semibold">
      ...
      <div className="flex flex-col items-center justify-center gap-6 md:flex-row md:items-start">
        <div className="flex w-full flex-col items-center justify-center gap-2 md:w-48">
          ...
          <p className="font-bold">
            {"A potential employer is interested in your hobby projects."}
          </p>
        </div>
        <svg
          className="fill-github-white w-16 shrink-0 opacity-70 max-md:-scale-x-100 md:-rotate-90"
          viewBox="0 0 138 138"
          fill="none"
        ...
        <div className="flex w-full flex-col items-center justify-center gap-2 md:w-48">
          <span className="text-4xl">🥸</span>
          <p className="font-bold">
            {"You prefer to keep your repositories out of the public eye."}
          </p>
        </div>
        <svg
          className="fill-github-white w-16 shrink-0 opacity-70 md:-rotate-90 md:-scale-x-100"
          viewBox="0 0 138 138"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
